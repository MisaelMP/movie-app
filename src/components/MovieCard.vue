<template>
    ...
    <div class="c-movie-card__content">
      ...
      <p class="c-movie-card__text"><span>Language:</span> {{ singleMovie.Language }}</p>
      <p class="c-movie-card__text"><span>Director: </span>{{ singleMovie.Director }}</p>
      <p class="c-movie-card__text"><span>Actors:</span> {{ singleMovie.Actors }}</p>
      <p class="c-movie-card__text"><span>Duration:</span> {{ singleMovie.Runtime }}</p>
    </div>
    <div class="c-movie-card__image-wrapper">
      <img :src="singleMovie.Poster" :alt="singleMovie.Title" class="c-movie-card__image">
    </div>  
	</div>
</template>
<script setup>
